                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <h2 style="float: right;"><a target="_blank" href="<?php echo e(route('product', ['id'=>encrypt($product->id)])); ?>" class="btn btn-primary" style="margin-top: -20px;">Quick View</a></h2>
                                    </div>
                                    <div class="body">
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
...
<?php /**PATH C:\wamp64\www\pakcompany2\resources\views/admin/product-management/products/edit-product.blade.php ENDPATH**/ ?>