<aside id="leftsidebar" class="sidebar">
           ...
           <li>
            ...
            <li>
                ...
                <ul class="ml-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('driver.view')); ?>">Driver </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('ds.shipping.shipping_orders_view')); ?>">Order Shipping </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('vehical.view')); ?>">Vehicle </a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
 ...
 <?php if(Auth::user()->is_admin==1): ?>
    ...
    <!-- #Footer -->
</aside><?php /**PATH /home/webeasydemos/public_html/pakcompany/resources/views/admin/layout/left-sidebar.blade.php ENDPATH**/ ?>