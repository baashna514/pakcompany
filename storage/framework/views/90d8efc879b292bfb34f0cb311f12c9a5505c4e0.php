                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        ...
                                                        <div class="button-group">
                                                            ...
                                                            <a href="<?php echo e(route('product', ['id'=>($product->id)])); ?>" data-id="<?php echo e($product->id); ?>" class="addToCart" title="Add" type="button" style="font-size: 12px;"><i class="fa fa-eye"></i>  <span> View Detail</span>
                                                            </a>
                                                            <button data-id="<?php echo e($product->id); ?>" class="btn-button wishlist" type="button" title="Add to Wish List"><i class="fa fa-heart"></i><span></span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div> 
                            ...
                            <?php $__currentLoopData = $top_collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="content-box">
                                    <div class="image-cat">
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('top-collections.get-products', ['title'=> $title, 'id'=> ($collection->category_id)])); ?>" title="<?php echo e($collection->title); ?>" target="_self">
                                            <img src="<?php echo e(asset('public/top-collection').'/'.$collection->image); ?>" title="<?php echo e($collection->title); ?>" alt="loading image" />
                                        </a>
                                    </div>
                                    <div class="cat-title"> 
                                        <a href="<?php echo e(route('top-collections.get-products', ['title'=> $title, 'id'=> ($collection->category_id)])); ?>" title="<?php echo e($collection->title); ?> " target="_self"> <?php echo e($collection->title); ?></a>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
...
</html><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/front/index.blade.php ENDPATH**/ ?>