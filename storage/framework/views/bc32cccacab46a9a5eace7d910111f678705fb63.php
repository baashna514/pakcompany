                    ...
                    <div class="category-derc">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="banners">
                                    <div>
                                        <a  href="#"><img src="<?php echo e(asset('public/front/image/slider2.jpg')); ?>" alt="img cate" style="width: 100%;"><br></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                ...
                                                ?>
                                                <a href="<?php echo e(route('product', ['id'=>encrypt($product->id)])); ?>" target="_self" title="<?php echo e($name); ?>">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="<?php echo e(route('product', ['id'=>encrypt($product->id)])); ?>" title="<?php echo e($product->name); ?>" target="_self"><?php echo e(Str::limit($product->name, 30)); ?></a></h4>
                                                <?php if($product->sale_price): ?>
                                                    <p class="price">   
...
</html><?php /**PATH /home/webeasydemos/public_html/pakcompany/resources/views/front/category-products/all-products-list.blade.php ENDPATH**/ ?>