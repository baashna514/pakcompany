    ...
    <div class="main-container container">
        ...
        <div class="row" style="text-align:center;">
            ...
            <div class="col-lg-6 col-sm-6 col-xs-12 contact-form" style="background: #0c8d4d;padding: 20px;color: #fff;border-radius: 5px;">
                <form action="<?php echo e(route('contact-post')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <?php echo csrf_field(); ?>
                    <fieldset>
...
</html><?php /**PATH /home/webeasydemos/public_html/pakcompany/resources/views/front/contact-us.blade.php ENDPATH**/ ?>