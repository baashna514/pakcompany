                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Store Setting
                                <small>New Top Collection</small>
                            </h2>
                        </div>
                        <div class="body">
                            <form action="<?php echo e(route('md.store-setting.top-collections-action')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="bg_color">Collection:</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="title" class="form-control" placeholder="Collection Title"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="custom-file-container" data-upload-id="slider">
                                                    <label style="color: #555;">Image: (308x230 px)<a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image"></a></label>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img class="thumbnail" style="width: 170px;" src="<?php echo e(asset('public/top-collection/').'/'.$collection->image); ?>" alt="">
                                            </td>
                                            <td><?php echo e($collection->title); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('top-collection-delete', ['id' => $collection->id])); ?>" class="btn btn-primary"><i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
...
<?php /**PATH C:\wamp64\www\pakcompany2\resources\views/admin/store-settings/top-collections.blade.php ENDPATH**/ ?>