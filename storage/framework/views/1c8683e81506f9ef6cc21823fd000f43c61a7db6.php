...
<body class="res layout-1">
	...
	<div class="main-container container">
		<ul class="breadcrumb">
			...
			<li><a href=""><?php echo e($name); ?></a></li>
		</ul>
		<div class="row">
			<!--Middle Part Start-->
                                    ...
                                    <div class="product-item-container">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="<?php echo e(route('product', ['id'=>($product->id)])); ?>" title="Chicken swinesha" target="_self"><?php echo e(Str::limit($product->name, 30)); ?></a></h4>
                                                <?php if($product->sale_price): ?>
                                                    <div class="price"> <span class="price-new">Rs. <?php echo e($product->sale_price); ?></span>
...
</html><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/front/category-products/top-collection-products-list.blade.php ENDPATH**/ ?>