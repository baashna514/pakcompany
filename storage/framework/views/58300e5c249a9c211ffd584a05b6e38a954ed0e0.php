                                        ...
                                        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-color: black: ">
                                                    ...
                                                    <input type="checkbox" class="check_id form-control" id="checkbox<?php echo e($key); ?>"  value="<?php echo e($comment->id); ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo e(route('ds.comment.delete', ['id' => $comment->id])); ?>" class="btn btn-primary"><i class="material-icons">delete</i></a>
                                                </td>
                                            </tr>
...
$(document).on('click','#change',function(){
   ...
   $('.check_id').each(function () {
    ...
    $.ajax({
        type:'post',
        url:'<?php echo e(route("update.comment.status")); ?>',
       data: {
            "id": id,
             "status":status
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\pakcompany\resources\views/admin/comments/view.blade.php ENDPATH**/ ?>