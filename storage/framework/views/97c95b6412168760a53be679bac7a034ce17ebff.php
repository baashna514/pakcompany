                                                                            ...
                                                                            <?php if($sub1->subcategory2): ?>
                                                                                <ul class="submenu-3">
                                                                                    <?php $__currentLoopData = $sub1->subcategory2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <li><a href="<?php echo e(route('subcategory2-products-list',['id' => encrypt($sub1->id)])); ?>"><?php echo e($sub2->name); ?></a></li>
...
</div><?php /**PATH C:\wamp64\www\pakcompany\resources\views/front/layout/menu.blade.php ENDPATH**/ ?>