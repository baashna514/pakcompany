                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('product.order.view',$order->id)); ?>">view Detail</a>
                                                    <a href="" data-id="<?php echo e($order->id); ?>" class="preview btn btn-primary"><i class="material-icons">preview</i></a>
                                                    <a data-id="<?php echo e($order->id); ?>" href="<?php echo e(route('order.print-order', ['id' => $order->id])); ?>" title="Print Order" class="btn btn-primary btn-print"><i class="material-icons">print</i></a>
                                                </td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/admin/orders/orders.blade.php ENDPATH**/ ?>