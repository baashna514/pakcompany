                                    ...
                                    <tbody >
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <td>
                                                    <a href="<?php echo e(route('ds.product-management.edit-product-form', ['id' => $id])); ?>" class="btn btn-primary"><i class="material-icons">edit</i></a><br>
                                                    ...
                                                    <a href="#" data-id="<?php echo e($product->id); ?>" class="btn btn-primary btn-quick-edit"><i class="material-icons">edit_road</i></a>
...
$('.btn-quick-edit').on('click', function(e){
    ...
    $.ajax({
        type: "GET",
        url: "<?php echo e(route('product.get-product-quick-detail')); ?>",
        data: {id:id},
...
$("#showProductQuickViewData").on('click', '#update-product', function(e){
    ...
    $.ajax({
        url: "<?php echo e(route('product.update-product-quick-detail')); ?>",
        method: "POST",
        data: {
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/admin/product-management/products/products-list.blade.php ENDPATH**/ ?>