        ...
        <tr>
            ...
            <td class="text-left" width="200px">
                <div class="input-group btn-block quantity">
                    <input type="number" name="quantity" id="quantityChange" value="<?php echo e($cart->quantity); ?>" class="form-control" />
                    <span class="input-group-btn">
                        <button type="submit" data-id="<?php echo e($cart->id); ?>" data-toggle="tooltip" title="Update" class="btn btn-primary edit"><i class="fa fa-edit"></i></button>
...
<?php endif; ?>
<input type="hidden" id="total" name="total" value="<?php echo e($sum); ?>"><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/front/includes/myCartPage_cartItems.blade.php ENDPATH**/ ?>