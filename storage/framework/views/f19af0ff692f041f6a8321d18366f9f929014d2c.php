                    ...
                    <div class="category-derc">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="banners">
                                    <div>
                                        <a  href="#"><img src="<?php echo e(asset('public/front/image/slider2.webp')); ?>" alt="img cate" style="width: 100%;"><br></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                ...
                                                ?>
                                                <a href="<?php echo e(route('product', ['id'=>($product->id)])); ?>" target="_self" title="<?php echo e($name); ?>">
                                                    <a href="<?php echo e(route('product', ['id'=>($product->id)])); ?>" target="_self" title="<?php echo e($product->name); ?>">
                                                        <img src="<?php echo e(asset('public/thumbnail/').'/'.$product->p_thumbnail); ?>" class="img-1 img-responsive" alt="<?php echo e($product->name); ?>">
                                                        <img src="<?php echo e(asset('public/thumbnail/').'/'.$product->p_thumbnail); ?>" class="img-2 img-responsive" alt="<?php echo e($product->name); ?>">
                                                    </a>
                                                </a>
                                            </div>
                                            <div class="box-label"> 
                                                <?php if($product->p_type == 'simple product'): ?>
                                                    ...
                                                    <?php if($product->sale_price): ?>
                                                        <span class="label label-sale">-<?php echo e(number_format((float)$perc, 0, '.', '')); ?>%</span>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
                                            <div class="button-group so-quickview cartinfo--left">
                                                ...
                                                <button type="button" data-id="<?php echo e($product->id); ?>" class="wishlist btn-button" title="Add to Wish List"><i class="fa fa-heart"></i><span>Add to Wish List</span>
                                                </button>
                                                <!--quickview-->                                                      
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="<?php echo e(route('product', ['id'=>($product->id)])); ?>" title="<?php echo e($product->name); ?>" target="_self"><?php echo e(Str::limit($product->name, 30)); ?></a></h4>
                                                <?php if($product->sale_price): ?>
                                                    <p class="price">   
                                                ...
                                                <?php else: ?>
                                                    <p class="price">   
                                                        <span class="price-new" id="price" data-id="<?php echo e($product->price); ?>">Rs. <?php echo e($product->price); ?></span>
                                                    </p>
                                                <?php endif; ?>
                                                ...
                                                <div class="list-block">
                                                    <button class="wishlist btn-button" type="button" title="Add to Wish List" onclick="wishlistfunction(<?php echo e($product->id); ?>)"><i class="fa fa-heart"></i>
                                                    </button>
...
</html><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/front/category-products/all-products-list.blade.php ENDPATH**/ ?>