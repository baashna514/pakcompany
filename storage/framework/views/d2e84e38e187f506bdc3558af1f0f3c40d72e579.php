        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 header-social">
                    <ul>
                        <li style="margin-left: 5px;letter-spacing: 12px;"><a href="https://www.facebook.com/PakCompanyOfficial/" target="_blank" style="color:#585656;"><img src="<?php echo e(asset('public/front/image/facebook.webp')); ?>" alt="facebook" title="Facebook" style="width: 40px;"></a>
                            <a href="https://www.instagram.com/pakcompanyofficial/" style="color:#585656;"><img src="<?php echo e(asset('public/front/image/instagram.webp')); ?>" title="Instagram" alt="instagram" style="width: 40px;"></a>
                            <a href="https://wa.me/923334210917/?text=Hi..! How may i help you?" style="color:#585656;"><img src="<?php echo e(asset('public/front/image/whatsapp.webp')); ?>" alt="whatsapp" title="Whatsapp" style="width: 40px;"></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-4">
                    <ul>
                        ...
                        <li>
                            <form class="header-search" method="POST" action="<?php echo e(route('main-search')); ?>">
                                                ...
                                                <div class="box-category">
                                                    <ul id="cat_accordion" class="list-group">
                                                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            ?>
                                                            <li <?php if(count($category->subcategories)>0){ ?>class="hadchild" <?php } ?> ><a href="<?php echo e(route('category-products-list',['name' => $cat, 'id' => $category->id])); ?>" class="cutom-parent"><?php echo e($category->name); ?></a>   <span <?php if(count($category->subcategories)>0){ ?>class="button-view  fa fa-plus-square-o" <?php } ?> ></span>
                                                                <?php if($category->subcategories): ?>
                                                                    <ul style="display: block;">
                                                                        <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li <?php if(count($subcategory->subcategory1)>0){ ?>class="hadchild" <?php } ?> ><a href="<?php echo e(route('subcategory-products-list',['id' => encrypt($subcategory->id)])); ?>" class="cutom-parent"><?php echo e($subcategory->name); ?></a>   <span <?php if(count($subcategory->subcategory1)>0){ ?>class="button-view  fa fa-plus-square-o" <?php }  else{ echo'class="dcjq-icon"'; }?> ></span>
                                                                                <?php if($subcategory->subcategory1): ?>
                                                                                    <ul style="display: none;" class="layer2">
                                                                                        <?php $__currentLoopData = $subcategory->subcategory1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <li <?php if(count($sub1->subcategory2)>0){ ?>class="hadchild" <?php } ?>><a href="<?php echo e(route('subcategory1-products-list',['id' => encrypt($sub1->id)])); ?>" class="cutom-parent"><?php echo e($sub1->name); ?></a>   <span <?php if(count($sub1->subcategory2)>0){ ?>class="button-view  fa fa-plus-square-o" <?php }  else{ echo'class="dcjq-icon"'; }?> ></span>
...
<script>
    $(document).ready(function(){
        $.get('<?php echo e(route("main-header.get-wishlist")); ?>', function(response){
...
</script><?php /**PATH C:\wamp64\www\pakcompany2\resources\views/front/layout/header.blade.php ENDPATH**/ ?>