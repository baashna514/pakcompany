    ...
    <table class="table table-bordered">
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td><input type="text" value="<?php echo e($weight); ?>" name="weight" value="0" id="weight" readonly style="text-align: right;background-color: #ffffff;font-size: 14px;padding:0px;"></td>
            </tr>
            <tr>
                <td class="text-right" colspan="3"><strong>Shipping Rate:</strong></td>
                <td><input type="text" name="shipping_charges" value="0" id="shipping_method" readonly style="text-align: right;background-color: #ffffff;font-size: 14px;padding:0px;"></td>
            </tr>
            <tr>
...
</div><?php /**PATH /home/webeasydemos/public_html/pakcompany/resources/views/front/includes/checkoutPage_cartItems.blade.php ENDPATH**/ ?>