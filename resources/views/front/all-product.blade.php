                ...
                <div class="products-category">
                            ...
                            <div class="product-item-container">
                                <div class="left-block">
                                    <div class="product-image-container second_img">
                                        ...
                                        @endphp
                                        <a href="{{ route('product', ['id'=>encrypt($product->id)]) }}" target="_self" title="{{ $name }}">
                                ...
                                <div class="right-block">
                                    <div class="caption">
                                        ...
                                        <h4><a href="product.html" title="Chicken swinesha" target="_self">{{Str::limit($product->name, 18)}}</a></h4>
                    ...
                    <div class="product-filter product-filter-bottom filters-panel">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">{{ $minProduct->links() }}</div>
                        </div>
                    </div>
                    <!-- //end Filters -->
    ...
    <form id="idform" class="type_2" action="{{route('shopfilter')}}">
      ...
      <div class="table_layout filter-shopby">
          <div class="table_row">
              ...
              <!-- - - - - - - - - - - - - - Price - - - - - - - - - - - - - - - - -->
              <div class="table_cell">
                      <legend>Price</legend> <input type="checkbox" id="priceCheck" name="">
                  
                  <fieldset class="table_cell12">
                      <div class="range">
                          Range :
