...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('public/front/ico/favicon-16x16.png')}}"/>
    ...
    <link href="{{ asset('public/front/css/footer/footer4.css') }}" rel="stylesheet">
					...
					<div class="left-content-product">
						...
						<div class="content-product-right col-md-7 col-sm-12 col-xs-12">
							...
							<div class="product-label form-group">
									...
									<div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
                                        @if ($product->p_type == 'simple product')
                                            @if ($product->sale_price)
                                                <span class="price-new p-price" name="{{ $product->sale_price }}" itemprop="price" style="font-size: 16px;">Rs. {{ $product->sale_price }} -PKR</span>
                                                <span class="price-old p-price" name="{{ $product->price }}">Rs. {{ $product->price }} - PKR</span>
                                            @else
                                                <span class="price-new p-price" name="{{ $product->price }}" itemprop="price" style="font-size: 16px;">Rs. {{ $product->price }} - PKR</span>
                                            @endif
                                        @endif
								...
								@endif
                                <div class="stock">
                                    {{-- <a href="" class="btn btn-info btn-chat" id="addClass">Chat With Vendor</a> --}}
                                </div>
							</div>
				 ...
				 <script type="text/javascript">
					...
					var cart = {
						'add': function(product_id, quantity) {
							parent.addProductNotice('Product added to Cart', '<img src="{{ asset("public/front/image/demo/shop/product/e11.jpg") }}" alt="">', '<h3><a href="#">Apple Cinema 30"</a> added to <a href="#">shopping cart</a>!</h3>', 'success');
						}
					}

					var wishlist = {
						'add': function(product_id) {
							parent.addProductNotice('Product added to Wishlist', '<img src="{{ asset("public/front/image/demo/shop/product/e11.jpg") }}" alt="">', '<h3>You must <a href="#">login</a>  to save <a href="#">Apple Cinema 30"</a> to your <a href="#">wish list</a>!</h3>', 'success');
						}
					}
					var compare = {
						'add': function(product_id) {
							parent.addProductNotice('Product added to compare', '<img src="{{ asset("public/front/image/demo/shop/product/e11.jpg") }}" alt="">', '<h3>Success: You have added <a href="#">Apple Cinema 30"</a> to your <a href="#">product comparison</a>!</h3>', 'success');
						}
					}
