				...
				<div class="so-onepagecheckout row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
								...
								{{-- <div class="form-group required">
									<label for="input-payment-postcode" class="control-label">Shipping Type</label>
...
<!-- Include Libs & Plugins
	...
	<script>
		$(document).ready(function(){
			...
			// $.get('{{ route("get-shipping-rate-by-weight") }}', function(data){
			// 	// alert(data);
			// 	// return;
			...
			// $.ajax({
			// 	url: "{{ route('get-shipping-rate-by-weight') }}",
			// 	type: "POST",   
			// 	data: {
			// 	"_token": "{{ csrf_token() }}",
			// 	weight: weight,
