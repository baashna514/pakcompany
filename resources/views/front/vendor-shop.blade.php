		...
		<div class="row">
            ...
            <div id="content" class="col-md-9 col-sm-8">
                <div class="products-category">
                    <h3 class="title-category ">{{$user->shop_name}}</h3>
                    <div class="category-derc">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="banners">
                                    <div>
                                        <a  href="#"><img src="{{asset('public/vendor-banners/'.$user->shop_banner)}}" alt="img cate"><br></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                ...
                                                @endphp
                                                <a href="{{ route('product', ['id'=>$id]) }}" target="_self" title="Chicken swinesha">
                                                    @if ($product->integration_id)
                                                    <img src="{{ $product->p_thumbnail }}" class="img-1 img-responsive" alt="image">
                                                    <img src="{{ $product->p_thumbnail }}" class="img-2 img-responsive" alt="image">
                                                    @else
                                            ...
                                            <div class="box-label"> 
                                                ...
                                                @if ($product->sale_price)
                                                    <span class="label-product label-sale">-{{number_format((float)$perc, 1, '.', '') }}%</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="" title="Chicken swinesha" target="_self">{{Str::limit($product->name, 18)}}</a></h4>
                                                <div class="price">
                                                    @if ($product->sale_price)
