                    ...
                    <div class="category-derc">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="banners">
                                    <div>
                                        <a  href="#"><img src="{{asset('public/front/image/slider2.webp')}}" alt="img cate" style="width: 100%;"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-item-container">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="{{ route('product', ['id'=>($product->id)]) }}" title="Chicken swinesha" target="_self">{{Str::limit($product->name, 30)}}</a></h4>
                                                @if ($product->sale_price)
                                                    <div class="price"> <span class="price-new">Rs. {{$product->sale_price}}</span>
                                                        <span class="price-old">Rs. {{$product->price}}</span>
                                                    </div>
                                                @else
                                                    <div class="price"> <span class="price-new" style="font-size: 16px;">Rs. {{$product->price}}</span></div>
                                                @endif
