                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container second_img">
                                                ...
                                                @endphp
                                                <a href="{{ route('product', ['id'=>($product->id)]) }}" target="_self" title="Chicken swinesha">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                @if ($product->sale_price)
                                                    <div class="price"> <span class="price-new" style="font-size: 16px;">Rs. {{$product->sale_price}}</span>
