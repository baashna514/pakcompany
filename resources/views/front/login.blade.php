		...
		<div class="row">
			<div id="content" class="col-sm-12">
				<div class="page-login">
					...
					<form action="{{route('user.login.authenticate')}}" method="post" enctype="multipart/form-data">
						@csrf
								<div class="col-sm-6 customer-login">
									...
									<div class="bottom-form">
										<a href="{{route('password.update')}}" class="forgot">Forgotten Password</a>
									...
									{{-- <a href="{{ url('/auth/google') }}" class="btn btn-facebook">Google</a> --}}
								</div>
							</form>
						</div>
					</div>
