                        ...
                        {{-- <div class="content-about-us"> --}}
                            {{-- <div class="des-about-us"> --}}
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <p>Pak Company came into being in 1932 when Late Syed Ahmad Shah started publishing textbooks approved for the provinces of Punjab, Sindh, and Calcutta. It was not until the early 70s when Pak Company started publishing the Holy Quran. These publications were done under the name M/S Pak Company which was under the trademark of M/S West Pak Publishing co. (Pvt.) Ltd. </p>
                                        <p>By the grace of the Almighty, we are the first Pakistani company that has introduced, developed, and proudly published the Holy Quran from the computerized calligraphy Arabic font. This is the main reason that our publications are free of any errors and flaws in the text. Different qualities of paper and bindings are available and the translations of The Holy Quran and sipara sets are available in the following languages:</p>
                                        <p>1.English
                                            2.Roman English
                                            3.Persian (Farsi) 
                                            4.Urdu
                                            5.Sindhi
                                            The approved specimen is specified by the Ministry of Religious Affairs, Government of Pakistan, Islamabad. 
                                            We offer a variety of products that ensure perfect quality and accuracy.
                                            These include: 
                                            1. Holy Quran 
                                            	Hamail Shareef 
                                            	Hafzi 
                                            	Tajweedi 
                                            	Pocket size Holy Quran 
                                            2. Punj Surah 
                                            3. Sipara Set 
                                            4. Surah 
                                            5. Manzil 
                                            ...
                                            10. Qurani Aayat 
                                            11. Qaida
                                            All products mentioned above are available WITH TRANSLATION & WITHOUT TRANSLATION.
                                            </p>
                                            <ol>
                                                <li>English</li>
                                                <li>Roman English</li>
                                            ...
                                            <p>The approved specimen is specified by the Ministry of Religious Affairs, Government of Pakistan, Islamabad. 
                                                We offer a variety of products that ensure perfect quality and accuracy.
                                                These include:
                                            </p>
                                            <ol>
                                                <li>Holy Quran
                                                    <ul>
                                                        <li>Hamail Shareef</li>
                                                        <li>Hafzi</li>
                                                        <li>Tajweedi</li>
                                                        <li>Pocket size Holy Quran</li>
                                                    </ul>
                                                </li>
                                                <li>Punj Surah</li>
                                                <li>Sipara Set</li>
                                                ...
                                                <li>Majmua Wazaif</li>
                                                <li>Single paras</li>
                                                <li>Dalail ul Khairat</li>
                                                <li>Qurani Aayat</li>
                                                <li>Qaida</li>
                                            </ol>
                                            <p>All products mentioned above are available WITH TRANSLATION & WITHOUT TRANSLATION.</p>
                                    </div>
                                </div>
