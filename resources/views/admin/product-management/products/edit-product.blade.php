...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form  action="{{ route('ds.product-management.edit-product-action',$product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Exportable Table -->
                <div class="row clearfix">
                    <!-- Left Content -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <h2 style="float: right;"><a target="_blank" href="{{ route('product', ['id'=>encrypt($product->id)]) }}" class="btn btn-primary" style="margin-top: -20px;">Quick View</a></h2>
                                    </div>
                                    <div class="body">
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" value="{{$product->p_quantity}}" name="p_quantity" class="form-control" placeholder="product quantity" required/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" value="{{$product->sale_price}}" name="sale_price" class="form-control" placeholder="price"/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="date" value="{{$product->from}}" name="from" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <label for="price">To</label>
                                                         <input type="date" value="{{$product->to}}" name="to" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="p_detail" id="p_detail"  placeholder="{{$product->p_detail}}" class="form-control" cols="100" rows="5" placeholder="product detail">{{ $product->p_detail}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea class="form-control" name="p_description" id="p_description" cols="100" rows="3">{{$product->p_description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" value="{{$product->weight}}" name="weight" class="form-control" placeholder="Package Weight">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                @if ($product->subcategory_id)
                                    <div class="form-group">
                                        ...
                                        @if($product->category)
                                            <input type="hidden" value="{{$product->category_id}}" id="category">
                                        @endif  
                                        @if ($product->subcategory_id)
                                            <input type="hidden" value="{{$product->subcategory_id}}" id="subcategory">
                                        @endif
                                        @if ($product->brand_id)
                                            <input type="hidden" value="{{$product->brand_id}}" id="brand">
                                        @endif
                                            ...
                                            @if($subcategories)
                                                ...
                                                @foreach($subcategories as $subcat)
                                                    @if($product->subcategory_id==$subcat->id)
                                                        <option selected="selected" id="subcategoryOption" value="{{$subcat->id}}">{{$subcat->name}}</option>
                                                    @else
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <select name="brand_id"  class="form-control show-tick ms  select2 brand" required>
                                            @if($brands)
                                                ...
                                                <option selected="selected" id="subcategoryOption" value="{{$b->id}}">{{$b->name}}</option>
                                                @else
