                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <select name="subcategory1_id"  class="form-control show-tick ms subcategory1">
                                                        @if($subcategories)
                                                            ...
                                                            @foreach($subcategories as $subcat)
                                                                <option id="subcategory1Option" value="{{$subcat->id}}">{{$subcat->name}}</option>
                                                            @endforeach
                                                            @endif
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <select name="subcategory2_id"  class="form-control show-tick ms subcategory2">
                                                        @if($subcategories)
                                                            ...
                                                            @foreach($subcategories as $subcat)
                                                                <option id="subcategory2Option" value="{{$subcat->id}}">{{$subcat->name}}</option>
                                                            @endforeach
                                                            @endif
                                                    </select>
                                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.subcategory').on('change', function() {
                ...
                $.ajax({
                    type:'get',
                    url:'{{route("ds.product-management.getSubcategory1BySubcategory")}}',
                    data: {id:subcat_id},
                    dataType: "json",
                    success:function(response){
            ...
            $('.subcategory1').on('change', function() {
                ...
                $.ajax({
                    type:'get',
                    url:'{{route("ds.product-management.getSubcategory2BySubcategory")}}',
                    data: {id:subcat_id},
                    dataType: "json",
                    success:function(response){
