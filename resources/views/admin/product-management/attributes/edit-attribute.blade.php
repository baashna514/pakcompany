            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('ds.product-management.attributes-update', ['id' => $attribute->id]) }}" method="POST">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" value="{{ $attribute->name }}" name="attribute" class="form-control" placeholder="Attribute Name"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                @if ($attribute->name == 'color' || $attribute->name == 'Color' || $attribute->name == 'COLOR')
                                                    <input name="value" id="value" placeholder="enter value" type="color" class="form-control">
                                                @else
                                                    <input name="value" id="value" placeholder="enter value" type="text" class="form-control">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        @foreach ($attribute->values as $key=>$values)
                                        @php
                                            $index = $key + 1;
                                        @endphp
                                        <tr>
                                            ...
                                            <td>{{ $values->name }}</td>
                                            @if ($attribute->name == 'color' || $attribute->name == 'Color' || $attribute->name == 'COLOR')
                                            <td><div style="    background: {{ $values->name }};width: 108px;height: 35px;"></div></td>
                                            @endif
                                            <td>
                                                <a href="{{ route('ds.product-management.value-delete', ['id' => $values->id]) }}" class="btn btn-primary"><i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
