                ...
                {{-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Product Management
                                <small>New Attribute</small>
                            </h2>
                        </div>
                        <div class="body">
                            <form action="{{ route('ds.product-management.attributes-action') }}" method="POST">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" value="" name="attribute" class="form-control" placeholder="Attribute Name"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('ds.product-management.attribute-edit', ['id' => $attribute->id]) }}" class="btn btn-primary"><i class="material-icons">edit</i></a>
                                                {{-- <a href="{{ route('ds.product-management.attribute-delete', ['id' => $attribute->id]) }}" class="btn btn-primary"><i class="material-icons">delete</i></a> --}}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
