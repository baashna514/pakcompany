            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('md.store-setting.top-collections-action') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $index }}</td>
                                            <td>
                                                <img class="thumbnail" style="width: 170px;" src="{{ asset('public/top-collection/').'/'.$collection->image }}" alt="">
                                            </td>
                                            <td>{{ $collection->title }}</td>
                                            <td>
                                                <a href="{{ route('top-collection-delete', ['id' => $collection->id]) }}" class="btn btn-primary"><i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
