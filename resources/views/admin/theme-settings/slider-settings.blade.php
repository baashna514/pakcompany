            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{ route('ds.theme-setting.slider-setting-action') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $index }}</td>
                                            <td>
                                                <img class="thumbnail" style="width: 100%;" src="{{ asset('public/slider/').'/'.$slider->image }}" alt="">
                                            </td>
                                            <td>
                                                <a href="{{ route('slider-delete', ['id' => $slider->id]) }}" class="btn btn-primary"><i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
