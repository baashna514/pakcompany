                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Theme Settings
                                <small>Favicon Setting</small>
                            </h2>
                        </div>
                        <div class="body">
                            <!-- Tab panes -->
                            <form action="{{ route('ds.theme-setting.favicon-setting-action') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="custom-file-container" data-upload-id="hd_logo">
                                                    <label style="color: #555;">Website Favicon: (300 x 200 Pixels)<a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image"></a></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <img src="{{ asset('public/theme').'/'.$row->hd_fevicon }}" alt="No Favicon" class="form-control" style="width:60px;height:60px;">
                                                @if($row->hd_fevicon) 
