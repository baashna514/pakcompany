                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!-- Tab panes -->
                            <form action="{{ route('ds.theme-setting.site-logo-action') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <img src="{{ asset('public/theme').'/'.$row->hd_img_logo }}" alt="No Logo Uploaded" class="form-control" style="width:100%;">
                                                        @if($row->hd_img_logo) 
                                                            <a href="{{ route('ds.theme-settings.remove-site-logo') }}">Remove logo</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
