...
<html>
<head>
	<title>Terms & Condtion</title>
</head>
<body>
Terms and Conditions
By using Daraz.pk (‘Site’) you agree to these terms and conditions, privacy policy, returns and refund policy of the Site. Please read the Terms and Conditions carefully before using Daraz.pk.

1. INTRODUCTION
Welcome to Daraz.pk also hereby known as “we", "us" or "Daraz". We are an online marketplace and these are the terms and conditions governing your access and use of Daraz along with its related sub-domains, sites, mobile app, services and tools (the "Site"). By using the Site, you hereby accept these terms and conditions (including the linked information herein) and represent that you agree to comply with these terms and conditions (the "User Agreement"). This User Agreement is deemed effective upon your use of the Site which signifies your acceptance of these terms. If you do not agree to be bound by this User Agreement please do not access, register with or use this Site. This Site is owned and operated by Jade E Services Pakistan Pvt Limited (Registration Number: '0080047)
...
We further expressly disclaim any warranties or representations (express or implied) in respect of quality, suitability, accuracy, reliability, completeness, timeliness, performance, safety, merchantability, fitness for a particular purpose, or legality of the products listed or displayed or transacted or the content (including product or pricing information and/or specifications) on the Site. While we have taken precautions to avoid inaccuracies in content, this Site, all content, information (including the price of products), software, products, services and related graphics are provided as is, without warranty of any kind. We do not implicitly or explicitly support or endorse the sale or purchase of any products on the Site. At no time shall any right, title or interest in the products sold through or displayed on the Site vest with us nor shall Daraz have any obligations or liabilities in respect of any transactions on the Site.
...
Daraz's Buyer-Seller Interaction Policy outlines the standard of behavior that sellers need to follow when connecting with customers on the Question & Answer Section, Instant Messenger, and Product Review Platform (of Daraz). Daraz monitors all kinds of buyer-seller communications and is authorized to take action in case of any violations.
...
These terms and conditions are governed by and construed in accordance with the laws of the Islamic Republic of Pakistan. You agree, as we do, to submit to the exclusive jurisdiction of the courts in Karachi.
